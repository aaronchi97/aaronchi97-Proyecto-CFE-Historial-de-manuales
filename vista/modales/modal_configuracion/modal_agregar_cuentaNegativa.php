...
<div class="modal fade" id="añadirCuentaNegativa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="fl-flex-label mb-4 px-2 col-12  campo">
                        ...
                        <input id="txtcuentaNeg<?= $_SESSION["id"] ?>" type="text" placeholder="INGRESA NUEVA CUENTA" autocomplete="off" class="mayuscula campo_motivo input input__text inputmodal input_modificado" name="txtagregar_cuenta">
                    </div>
