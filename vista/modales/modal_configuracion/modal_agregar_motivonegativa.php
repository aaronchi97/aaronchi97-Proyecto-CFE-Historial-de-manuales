...
<div class="modal fade" id="añadirMotivo_correccion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                <h5 class="modal-title w-100" id="exampleModalLabel">AÑADIR MOTIVO DE CORRECCIÓN</h5>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="text-right p-3">
                        <button style="margin-top: 5%;" type="submit" value="ok" name="btnregistrar_motivo_negativa" class=" submitButton btn btn-primary btn-rounded" disabled onclick="return confirm('¿Estás seguro de que deseas registrar esto?')">
