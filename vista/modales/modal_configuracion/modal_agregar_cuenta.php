...
<!-- --------------- AÑADIR A CADA MODAL UN ID QUE TENGA CONCATENADO EL ID DEL USUARIO QUE INICIA SESION ------------------------ -->

<div class="modal fade" id="añadirCuenta<?= $_SESSION["id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                <h5 class="modal-title w-100" id="exampleModalLabel">AÑADIR CUENTA</h5>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="fl-flex-label mb-4 px-2 col-12  campo">
                        ...
                        <input id="txtcuenta<?= $_SESSION["id"] ?>" type="text" placeholder="INGRESA NUEVA CUENTA" autocomplete="off" class="mayuscula campo_motivo input input__text inputmodal input_modificado" name="txtagregar_cuenta">
                    </div>
                    ...
                    <div class="text-right p-3">
                        <button style="margin-top: 5%;" type="submit" value="ok" name="btnregistrar" class=" submitButton btn btn-primary btn-rounded" disabled onclick="return confirm('¿Estás seguro de que deseas registrar esto?')">
