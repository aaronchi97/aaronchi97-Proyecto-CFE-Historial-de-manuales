...
<div class="modal fade" id="añadirRPE" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                <h5 class="modal-title w-100" id="exampleModalLabel">AÑADIR RPE AUXILIAR</h5>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="fl-flex-label mb-4 px-2 col-12  campo">
                        ...
                        <input id="txtrpe<?= $_SESSION["id"] ?>" type="text" placeholder="INGRESA NUEVO RPE AUXILIAR" autocomplete="off" class="mayuscula campo_motivo input input__text inputmodal input_modificado" name="txtagregar_rpe">
                    </div>
                    ...
                    <div class="text-right p-3">
                        <button style="margin-top: 5%;" type="submit" value="ok" name="btnregistrar_rpe" class=" submitButton btn btn-primary btn-rounded" disabled onclick="return confirm('¿Estás seguro de que deseas registrar esto?')">
