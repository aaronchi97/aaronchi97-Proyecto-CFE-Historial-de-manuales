            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="fl-flex-label mb-4 px-2 col-12  campo">
                        ...
                        <input id="txtmedidor<?= $_SESSION["id"] ?>" type="text" placeholder="INGRESA NUEVO MEDIDOR" autocomplete="off" class=" campo_motivo input input__text inputmodal input_modificado" name="txtagregar_medidor">
                    </div>
