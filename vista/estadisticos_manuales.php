...
<div class="page-content">
    ...
    <h4 style="margin-bottom: 5%;" class="text-center text-secondery">ESTADÍSTICOS MANUALES</h4>
    ...
    <label style="margin-bottom: 2%;" for="">Hola <span class="nombres-usuarios"><?= $_SESSION["nombre"] ?></span>, por favor selecciona acorde a tus necesidades:</label>
                    ...
                    <form class="fechas" method="post">
                        ...
                        <div class="opciones-container fecha_personalizada" style="display: none;">
                            ...
                            <div class="text-center p-3">
                                <button type="submit" value="ok" name="btn_verxfecha" class="btn btn-primary btn-rounded">Asignar</button>
                        ...
                        <div class="opciones-container ver_semestre" style="display: none;">
                            ...
                            <button type="submit" value="ok" name="btn_verxfecha" class="btn btn-primary btn-rounded" onclick="calcularMeses()">Asignar</button>
                            <a href="estadisticos_manuales.php" class="btn btn-danger btn-rounded">Cancelar</a>
                        </div>
                        ...
                        <div class="opciones-container ver_anio" style="display: none;">
                            ...
                            <div class="text-center p-3">
                                <button type="submit" value="ok" name="btn_verxfecha" class="btn btn-primary btn-rounded" onclick="calcularAnio()">Asignar</button>
                                <a href="estadisticos_manuales.php" class="btn btn-danger btn-rounded">Cancelar</a>
