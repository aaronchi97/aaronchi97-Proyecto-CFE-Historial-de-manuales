  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" style="margin-top: -15%;">
      <div class="carousel-item active" style="width: 100%;">
        <img src="../login/img/sinasu/slide-sinasu.jpg" style="filter: brightness(30%); " class="d-block w-100"
          alt="...">
        ...
        <img src="../login/img/CFE-icono.svg" alt="">
          ...
          <div class="botones-inicio-sinasu">
            <a class="btn-inicio-sinasu" href="agencia1.php">Subir documentación</a>
      ...
      <div class="carousel-item" style="width: 100%;">
        <img src="../login/img/sinasu/slide-sinasu2.jpg" style="filter: brightness(50%); " class="d-block w-100"
          alt="...">
        <div class="carousel-caption d-none d-md-block" style=" margin-bottom: 25%;">
    ...
    <button class="carousel-control-prev" style="margin-bottom: 0;" type="button" data-target="#carouselExampleCaptions"
      data-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </button>
    <button class="carousel-control-next" style="margin-bottom: 0;" type="button" data-target="#carouselExampleCaptions"
      data-slide="next">
