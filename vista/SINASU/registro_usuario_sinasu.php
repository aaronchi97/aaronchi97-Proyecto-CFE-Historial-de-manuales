  ...
  en el form tenemos que especificar el metodo POST-->
    ...
    <section class="formulario_usuario">
        ...
        <form action="" method="post" class="row g-2 " novalidate>
            ...
            <div class="fl-flex-label mb-3 px-2 col-12 col-md-6">
                <select class="input input__select" id="txtrol" name="txtrol" required>
                    <option value="" disabled selected hidden>Selecciona el rol</option>
            ...
            <div class="fl-flex-label mb-3 px-2 col-12 col-md-6">
                <!-- <img src="../public/images/itm-merida-fondo.webp" alt=""> -->
                <input type="password" placeholder="Contraseña" class="input input__text " id="floatingPassword"
                    name="txtpassword">
            </div>
