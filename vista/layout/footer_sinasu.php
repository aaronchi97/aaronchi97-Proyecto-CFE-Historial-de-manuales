<script src="../../public/bootstrap5/js/popper.min.js"
...
<script>
    $(function () {
        $('#example').DataTable({
            ...
            // "columnDefs": [
            //     { "padding": "20px", "targets": 1 }
            // ],
            // responsive: true,
            // scrollCollapse: true, // Desactiva la funcionalidad de desplazamiento de la fila
            "language": {
                "sProcessing": "Procesando...",
                "sLengthMenu": "Mostrar _MENU_ registros",
                "sZeroRecords": "No se encontraron resultados",
                "sEmptyTable": "Lo siento <?= $_SESSION["nombre-sinasu"] ?>, por el momento no hay archivos subidos ;-;",
            ...
            // "columnDefs": [
            //     { "width": "20%", "targets": 2 },  // Ajusta el ancho de la segunda columna al 30%
            //     { "width": "10%", "targets": [3, 4, 5] }  // Ajusta el ancho de la cuarta y quinta columna al 20%
            // ],
            // scrollX: true,
            // scrollY: 600
        });
