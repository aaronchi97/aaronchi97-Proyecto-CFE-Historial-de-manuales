...
<div class="page-content">
    ...
    <h4 style="margin-bottom: 5%;" class="text-center text-secondery"> CONFIGURACIÓN NEGATIVAS</h4>
    ...
    include "../controlador/control-configuracion/controlador_agregar_justificacion.php";
    include "../controlador/control-configuracion/controlador_agregar_medidor.php";
    include "../controlador/control-configuracion/controlador_agregar_motivo_negativas.php";
    ...
    <a data-toggle="modal" data-target="#añadirJustificacion" class="btn-reportes-configuracion ">AÑADIR JUSTIFICACION/RESPALDO<i class="fa-solid fa-book-open-reader"></i></a>

    <a data-toggle="modal" data-target="#añadirMotivo_correccion" class="btn-reportes-configuracion ">AÑADIR MOTIVO CORRECCION <i class="fa-solid fa-bolt"></i></a>
    ...
    <?php
    include "modales/modal_configuracion/modal_agregar_justificacion.php";
    include "modales/modal_configuracion/modal_agregar_motivonegativa.php";
