...
<body>
    ...
    <article class="bienvenida">
        ...
        <div class="wave" style="height: 150px; overflow: hidden;" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;"><path d="M-6.96,102.05 C139.20,201.61 271.29,-50.10 502.63,140.89 L500.00,0.00 L-0.00,0.00 Z" style="stroke: none; fill:#3F7C85;"></path></svg></div>
