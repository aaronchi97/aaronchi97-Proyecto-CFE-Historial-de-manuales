      ...
      $.each(columns, function (j, column) {
        ...
        if (column.checkbox) {
          if (!that.options.singleSelect && that.options.checkboxHeader) {
            text =
              '<div class="checkbox checkbox-only"><input id="datatable-chekbox-select-all" name="btSelectAll" type="checkbox" /><label for="datatable-chekbox-select-all"></label></div>';
          }
      ...
      $.each(this.columns, function (i, column) {
        ...
        if (column.switchable) {
          html.push(
            sprintf(
              "<li>" +
                '<span class="checkbox"><input id="datatable-columns-checkbox-' +
                i +
                '" type="checkbox" data-field="%s" value="%s"%s> <label for="datatable-columns-checkbox-' +
                i +
                '">%s</label></span>' +
                "</li>",
              column.field,
    ...
    if (this.options.showColumns) {
      ...
      $keepOpen
        ...
        .on("click", function () {
          ...
          that.toggleColumn(
            getFieldIndex(that.columns, $(this).data("field")),
            $this.prop("checked"),
            false
          );
          that.trigger(
